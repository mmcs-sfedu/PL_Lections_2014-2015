...
<a name="simplest-program">
## <a name="2"></a> Простейшая программа
</a>
...
<a name="var-init">
## <a name="5"></a> Способы инициализации переменных
</a>
...
<a name="implicit-cast">
## <a name="6"></a> Неявное преобразование типов
</a>
...
<a name="basic-operators">
## <a name="7"></a> Основные операции
</a>
...
<a name="conditional-operator">
### <a name="9"></a> Тернарная условная операция
</a>
...
<a name="switch-statement">
## <a name="10"></a> Оператор выбора
</a>
...
<a name="loops">
## <a name="11"></a> Операторы цикла
</a>

<a name="while">
### <a name="12"></a> Цикл `while`
</a>
...
<a name="comma-operator">
## <a name="15"></a> Оператор `,` (запятая)
</a>
