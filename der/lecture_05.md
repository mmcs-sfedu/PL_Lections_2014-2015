...
<a name="4">### Как передавать в функции C- и C++-строки
</a>
...
<a name="6">### Передача в функции двумерных массивов
</a>
...
<a name="7">## Определение типов в C++
</a>
...
<a name="10">### Передача параметров в функции
</a>
...
<a name="12">### Указатели на структуры
</a>
...
<a name="13">### Указатели и константность
</a>
...
<a name="14">### Константные указатели
</a>
