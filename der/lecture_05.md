...
### <a name="4"></a> Как передавать в функции C- и C++-строки
...
### <a name="6"></a> Передача в функции двумерных массивов
...
## <a name="7"></a> Определение типов в C++
...
### <a name="10"></a> Передача параметров в функции
...
### <a name="12"></a> Указатели на структуры
...
### <a name="13"></a> Указатели и константность
...
### <a name="14"></a> Константные указатели
```cpp
int = 5;
