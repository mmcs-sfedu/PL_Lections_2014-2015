...
<a name="1">## Стандартные функции для работы с C-строками
</a>
...
<a name="2">### Контроль памяти при работе с этими функциями
</a>
...
<a name="3">## Указатели и динамическая память
</a>
...
<a name="4">### Ошибки при работе с динамической памятью
</a>
...
<a name="5">## Массивы в динамической памяти(динамические массивы)
</a>
...
<a name="6">### Как передавать динамические массивы в функции
</a>
...
<a name="7">## Двумерные динамические массивы 
</a>
...
<a name="8">### Выделение памяти для статических массивов
</a>
...
<a name="9">### Выделение памяти для динамических массивов
</a>
...
<a name="10">### Передача двумерного динамического массива в функции
</a>
...
<a name="12">## Динамические структуры данных
</a>
