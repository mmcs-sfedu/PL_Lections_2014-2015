...
## <a name="1"></a> Стандартные функции для работы с C-строками
...
### <a name="2"></a> Контроль памяти при работе с этими функциями
...
## <a name="3"></a> Указатели и динамическая память
...
### <a name="4"></a> Ошибки при работе с динамической памятью
...
## <a name="5"></a> Массивы в динамической памяти(динамические массивы)
...
### <a name="6"></a> Как передавать динамические массивы в функции
...
## <a name="7"></a> Двумерные динамические массивы 


### <a name="8"></a> Выделение памяти для статических массивов
...
### <a name="9"></a> Выделение памяти для динамических массивов
...
### <a name="10"></a> Передача двумерного динамического массива в функции
...
## <a name="12"></a> Динамические структуры данных
