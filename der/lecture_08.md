...
## <a name="1"></a> Линейный односвязный список в динамической памяти
...
## <a name="2"></a> Добавление элемента в начало односвязного списка
...
### <a name="3"></a> Где хранить шаблоны функций, структур и классов.
...
### <a name="4"></a> Отличие шаблонов C++ от обобщений .NET
...
## <a name="5"></a> Цикл по односвязному списку
...
## <a name="6"></a> Указатели на функции
...
### <a name="7"></a> Действие передаваемое параметром (callback)
