...
<a name="1">## Линейный односвязный список в динамической памяти
</a>
...
<a name="2">## Добавление элемента в начало односвязного списка
</a>
...
<a name="3">### Где хранить шаблоны функций, структур и классов.
</a>
...
<a name="4">### Отличие шаблонов C++ от обобщений .NET
</a>
...
<a name="5">## Цикл по односвязному списку
</a>
...
<a name="7">### Действие передаваемое параметром (callback)
</a>
