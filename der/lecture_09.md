...
<a name="freeing_memory_occupied_list">
...
<a name="vectors_and_strings_cpp">
## Векторы и строки (С++)
</a>
...
<a name="classes_and_operator_overloading">
...
<a name="overloading_binary_operation">
...
<a name="passing_objects_to_func">
