...
<a id="functions" title="Функции" class="toc-item"></a>
## Функции
...
<a id="standard_features" title="Стандартные функции" class="toc-item"></a>
### Стандартные функции
...
<a id="inline_functions" title="inline-функции" class="toc-item"></a>
### inline-функции
...
<a id="links" title="Ссылки" class="toc-item"></a>
## Ссылки
...
<a id="passing_argument_to_func_by_reference" title="Передача аргумента в функцию по ссылке" class="toc-item"></a>
...
<a id="structure" title="Структуры" class="toc-item"></a>
## Структуры
...
<a id="transmission_struct_func" title="Передача структуры в функцию" class="toc-item"></a>
