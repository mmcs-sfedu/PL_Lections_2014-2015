...
<a id="iteration_on_set" title="Итерация по set" class="toc-item"></a>
### Итерация по set
...
<a id="requirements_from_variety_of" title="Требования от множества" class="toc-item"></a>
...
<a id="associative_dictionary" title="Ассоциативный словарь" class="toc-item"></a>
...
<a id="some_garbage" title="какая-то фигня" class="toc-item"></a>
### какая-то фигня
